<template>
  <div class="border rounded flex flex-col dark:border-zinc-500 shadow-lg bg-zinc-100 dark:bg-zinc-800">
    <div class="relative">
      ...
      <div v-else></div>
      <img :src='props.imageSrc' :alt="props.imageAlt" class="aspect-square rounded-t block">
    </div>
    <div class="flex flex-col items-center">
      ...
      <p class="text-zinc-500 w-full text-left px-2 mb-2">Uploaded: {{ prettyDate(new Date(parseInt(props.uploaded))) }}
      </p>
    </div>
    <hr>
    <div class="p-1 flex">
      <button class="p-2 m-1 inline-flex items-center rounded text-white bg-green-500 hover:bg-green-400">
      ...
      <button class="p-2 m-1 inline-flex items-center rounded text-white bg-red-500 hover:bg-red-400">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2 fill-white" viewBox="0 0 512 512">
          <path
      ...
      <button class="p-2 m-1 inline-flex items-center rounded text-white bg-blue-500 hover:bg-blue-400 mr-auto">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2 fill-white" viewBox="0 0 512 512">
          <path
