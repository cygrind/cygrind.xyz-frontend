<template>
  <div class="header">
    ...
    <div class="flex-row-items-center flex-grow">
      <img class="max-h-12 mx-4" src="/cygrind_logo_v2_128x128.png" alt="logo">
      ...
      <Menu>
        <span>
          ...
          <MenuItems>
            <span
              class="absolute flex flex-col my-2 p-2 rounded-md shadow border bg-white dark:border-zinc-500 dark:bg-zinc-900">
              <MenuItem>
              <a class="p-2 mb-2 rounded border dark:border-zinc-500 dark:hover:bg-zinc-800 shadow hover:shadow-inner"
                href="#">
                <!-- point to modal -->
                Log in
              </a>
              ...
              <MenuItem>
              <a class="p-2 rounded border dark:border-zinc-500 dark:hover:bg-zinc-800 shadow hover:shadow-inner"
                href="#">
                <!-- point to modal -->
                Sign up
              </a>
      ...
      <!-- Support me on Ko-fi -->
      <a href='https://ko-fi.com/L4L8BIHW8' class="ml-auto" target='_blank'><img height='36' style='border:0px;height:36px;'
          src='https://cdn.ko-fi.com/cdn/kofi3.png?v=3' border='0' alt='Buy Me a Coffee at ko-fi.com' /></a>
    </div>
  </div>
</template>
...
<style>
.header {
  @apply border-b-2 dark:border-zinc-700 p-4 flex flex-row items-center
}
